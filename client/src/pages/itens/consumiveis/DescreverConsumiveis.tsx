...
const DescreverConsumiveis = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const data = await obterConsumiveis(categoria)
    ...
    return (
        <ItemContainer destino={`/itens/consumiveis/${categoria}`}>
            <Box>
...
export default DescreverConsumiveis